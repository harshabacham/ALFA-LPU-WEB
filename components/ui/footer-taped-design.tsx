...
export const FooterTapedDesign = () => {
  ...
  return (
    <footer className="my-16 px-4 max-w-5xl mx-auto text-zinc-800 dark:text-zinc-200 relative select-none">
      {/* Tape design container block */}
      <div className="relative bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/60 rounded-3xl max-w-5xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-start gap-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
        
        {/* Playful Tapes on top corners */}
        <div className="hidden md:block absolute -top-5 -left-7 w-[80px] h-[36px] scale-75 origin-top-left hover:scale-80 transition-transform duration-300">
          {tape}
        </div>
        <div className="hidden md:block absolute -top-5 -right-7 rotate-90 w-[80px] h-[36px] scale-75 origin-top-right hover:scale-80 transition-transform duration-300">
          {tape}
        </div>
        ...
        <div className="flex-1 space-y-4 max-w-sm">
          <Link
            to="/"
            className="flex items-center gap-2.5 text-2xl font-black font-display tracking-tight text-[#fe7f2d] uppercase"
          >
            <div className="w-9 h-9 rounded-xl bg-[#fe7f2d] flex items-center justify-center text-white font-black text-sm shadow-md shadow-[#fe7f2d]/20">
              A
            </div>
            <span>Alfa Portal</span>
          </Link>
          <p className="text-zinc-500 dark:text-zinc-400 font-medium text-xs sm:text-sm leading-relaxed">
            The premier campus utility and community hub custom-tailored for LPU students. Find PG rooms, GPA calculators, course recommendations, chapter updates, and academic resources in one gorgeous panel.
          </p>
        </div>
      ...
      {/* Footer base line information */}
      <div className="mt-6 px-4 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-zinc-400 dark:text-zinc-500 font-mono tracking-wider">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 items-center">
          <p className="whitespace-nowrap uppercase">
            © {currentYear} ALFA Student Portal. All rights reserved.
          </p>
        ...
        <div className="flex gap-4 items-center">
          ...
          <a
            ...
            className="text-zinc-400 hover:text-[#fe7f2d] dark:text-zinc-500 dark:hover:text-[#fe7f2d] transition-colors"
          >
...
export { FooterTapedDesign as Component };
