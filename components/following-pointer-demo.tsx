...
export default function FollowingPointerDemo() {
  return (
    <div className="mx-auto w-80">
      ...
      >
        <div className="group relative h-full overflow-hidden rounded-2xl border border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 transition duration-200 hover:shadow-xl">
          <div className="relative aspect-[16/10] w-full overflow-hidden rounded-tl-lg rounded-tr-lg bg-gray-100 dark:bg-zinc-900">
            <img
          ...
          <div className="p-4">
            ...
            <div className="mt-10 flex flex-row items-center justify-between">
              ...
              <div className="relative z-10 block rounded-xl bg-black dark:bg-white dark:text-black px-6 py-2 text-xs font-bold text-white">
                Read More
              </div>
            </div>
          </div>
...
const TitleComponent = ({
  ...
  <div className="flex items-center space-x-2">
    <img
      ...
      width="20"
      alt="thumbnail"
      className="rounded-full border-2 border-white w-5 h-5 object-cover"
      referrerPolicy="no-referrer"
    />
    <p>{title}</p>
  </div>
