...
import { 
  ...
  Calculator, HelpCircle, ShieldCheck, Award, Heart
} from 'lucide-react';
...
const Home: React.FC = () => {
  ...
  return (
    <div className="relative animate-in fade-in duration-700 pb-12 overflow-x-hidden bg-grid-pattern">
        ...
        <div className="max-w-7xl mx-auto space-y-12">
            ...
            <div className="lg:col-span-7 text-left space-y-6 md:space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-zinc-500 dark:text-zinc-400 text-sm sm:text-base font-medium leading-relaxed max-w-xl">
                  Welcome to <span className="text-primary-600 dark:text-primary-400 font-bold font-display">ALFA(LPU)</span> — the open, student-run hub for Lovely Professional University. Discover verified semester notes, PYQs, GPA calculators, student marketplace, Law Gate PGs, and campus events.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4 pt-6 border-t border-zinc-200/55 dark:border-zinc-800/40 max-w-lg">
                <div className="text-left">
                  <div className="text-base sm:text-xl md:text-2xl font-black text-zinc-800 dark:text-zinc-100 font-display">10,000+</div>
                  <div className="text-[7px] xs:text-[8px] sm:text-[9px] md:text-[10px] font-bold text-zinc-400 uppercase tracking-widest font-display">Community Peers</div>
                </div>
                <div className="text-left">
                  <div className="text-base sm:text-xl md:text-2xl font-black text-primary-500 font-display">100%</div>
                  <div className="text-[7px] xs:text-[8px] sm:text-[9px] md:text-[10px] font-bold text-zinc-400 uppercase tracking-widest font-display">Free Peer Access</div>
                </div>
                <div className="text-left">
                  <div className="text-base sm:text-xl md:text-2xl font-black text-accent-500 font-display">500+</div>
              ...
              <div className="relative rounded-2xl bg-zinc-900/90 dark:bg-black/95 border border-zinc-800/50 dark:border-zinc-800 shadow-2xl overflow-hidden text-left flex flex-col h-[340px] md:h-auto md:aspect-[1.3] group">
                ...
                <div className="h-10 bg-zinc-950/90 dark:bg-black/90 px-4 flex items-center justify-between border-b border-zinc-800/40 shrink-0">
                  <div className="flex items-center gap-1.5">
                    <div className="w-3 h-3 rounded-full bg-rose-500 shadow-inner cursor-pointer"></div>
                    <div className="w-3 h-3 rounded-full bg-amber-500 shadow-inner cursor-pointer"></div>
                    <div className="w-3 h-3 rounded-full bg-emerald-500 shadow-inner cursor-pointer"></div>
                  </div>
                ...
                <div className="flex-grow p-4 pb-20 space-y-3.5 overflow-y-auto scrollbar-hide text-zinc-100 bg-zinc-950 font-sans">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {events.length > 0 ? (
                      <Link to="/events" className="block p-3 bg-zinc-900/60 hover:bg-zinc-900/80 rounded-xl border border-zinc-800/60 transition-all text-left group/widget">
                      ...
                      <div className="p-3 bg-zinc-900/60 rounded-xl border border-zinc-800/60 text-left">
                        <p className="text-xs font-black text-zinc-100 font-display">Campus Schedule</p>
                      </div>
                    )}

                    {deals.length > 0 ? (
                      <Link to="/deals" className="block p-3 bg-zinc-900/60 hover:bg-zinc-900/80 rounded-xl border border-zinc-800/60 transition-all text-left group/widget">
                        <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="p-3 bg-zinc-900/60 rounded-xl border border-zinc-800/60 text-left">
                        <p className="text-xs font-black text-zinc-100 font-display">Marketplace</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="absolute bottom-3 left-0 right-0 z-20 flex justify-center px-4 pointer-events-none">
                  <div className="px-3 sm:px-3.5 py-1.5 bg-zinc-900/95 dark:bg-zinc-950/95 backdrop-blur-md rounded-2xl border border-zinc-800/60 flex items-center gap-2 sm:gap-2.5 shadow-2xl pointer-events-auto">
                    {quickLinks.map((ql, i) => (
                      <Link 
                        key={i} 
                        to={ql.path} 
          ...
          {events.length > 0 ? (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              <div className="lg:col-span-7 flex flex-col justify-between p-6 md:p-8 rounded-[2.5rem] bg-white dark:bg-zinc-950 border border-zinc-200/60 dark:border-zinc-900 shadow-sm relative overflow-hidden group">
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                       <button 
                         onClick={handlePrev} 
                         className="w-9 h-9 flex items-center justify-center bg-zinc-50 dark:bg-zinc-900 text-zinc-600 dark:text-zinc-400 hover:text-primary-500 rounded-full border border-zinc-200/60 dark:border-zinc-800 transition-all cursor-pointer"
                       >
                         <ChevronLeft size={16} />
                       </button>
                       <button 
                ...
                <div className="flex items-center justify-between mt-6 pt-4 border-t border-zinc-100 dark:border-zinc-900/60">
                      ...
                      {events.map((_, i) => (
                        <button
                          ...
                          className={`h-1.5 rounded-full transition-all duration-500 cursor-pointer ${
                            i === currentSlide ? 'w-6 bg-primary-500' : 'w-1.5 bg-zinc-200 dark:bg-zinc-800'
                          }`}
                        />
                      ))}
                    </div>
                  ...
                  <Link 
                    ...
                    className="inline-flex items-center gap-2 text-xs font-bold text-primary-500 hover:text-primary-600 transition-colors uppercase tracking-widest font-display"
                  >
              ...
              <div className="lg:col-span-5 flex flex-col justify-between p-6 md:p-8 rounded-[2rem] bg-sand-50 dark:bg-zinc-900/60 border border-zinc-200/50 dark:border-zinc-800/40 shadow-sm relative overflow-hidden text-left">
                    ...
                    <div key={idx} className={`space-y-4 transition-all duration-500 ${idx === currentSlide ? 'block opacity-100' : 'hidden opacity-0'}`}>
                      <div className="space-y-3">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 rounded-md text-[10px] font-medium uppercase tracking-wider">
                            <Calendar size={11} className="text-primary-500" /> {event.date}
                          </span>
                        </div>
                        <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-100 leading-tight">
                          {event.title}
                        </h2>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 pt-4">
                        <div className="p-3 bg-zinc-50 dark:bg-zinc-900/50 rounded-xl border border-zinc-200/50 dark:border-zinc-800/60">
                          <span className="text-[9px] font-semibold text-zinc-400 uppercase tracking-widest block mb-1">Pass Price</span>
                          <span className="text-lg font-extrabold text-primary-500 dark:text-primary-400 font-display">₹{event.price || 'Free'}</span>
                        </div>
                        <div className="p-3 bg-zinc-50 dark:bg-zinc-900/50 rounded-xl border border-zinc-200/50 dark:border-zinc-800/60">
                          <span className="text-[9px] font-semibold text-zinc-400 uppercase tracking-widest block mb-1">Organizers</span>
                          <span className="text-xs font-bold text-zinc-700 dark:text-zinc-200 truncate block">{event.organizer || 'LPU Student Hub'}</span>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="pt-6 mt-6 border-t border-zinc-100 dark:border-zinc-800/40 flex flex-col sm:flex-row gap-3">
                  <Link 
                    to={`/events/${currentSlide}`} 
                    className="flex-grow inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-primary-600 text-white rounded-xl font-bold text-xs uppercase tracking-widest shadow-lg shadow-primary-600/15"
                  >
                    Get Tickets <Ticket size={15} />
                  </Link>
                  <Link 
                    to="/events" 
                    className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-zinc-50 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 rounded-xl font-bold text-xs uppercase tracking-widest border border-zinc-200/60 dark:border-zinc-700/50"
                  >
      ...
      {/* AdSense Ad Unit Placement 1 */}
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 my-6">
        <AdUnit label="Advertisement • LPU Student Sponsors" slot="1029384756" />
      </div>

      {/* Campus Quick Hub Navigation */}
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 mt-8 space-y-16">
        <section className="text-left">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 sm:gap-4">
            {[
              { name: 'Announcements', path: '/notifications', icon: Bell, color: 'text-rose-500 bg-rose-500/10 border-rose-500/10' },
              { name: 'Academic Notes', path: '/notes', icon: BookOpen, color: 'text-indigo-500 bg-indigo-500/10 border-indigo-500/10' },
              { name: 'Events Spotlight', path: '/events', icon: Calendar, color: 'text-primary-500 bg-primary-500/10 border-primary-500/10' },
              { name: 'Duty Leaves', path: '/duty-leaves', icon: Ticket, color: 'text-amber-500 bg-amber-500/10 border-amber-500/10' },
              { name: 'GPA Calculator', path: '/gpa', icon: Calculator, color: 'text-emerald-500 bg-emerald-500/10 border-emerald-500/10' },
              { name: 'SOS Emergency', path: '/emergency', icon: PhoneCall, color: 'text-red-500 bg-red-500/10 border-red-500/10' },
            ].map((link) => (
              <Link 
                key={link.name} 
                to={link.path} 
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <section className="lg:col-span-2 text-left">
            <div className="flex justify-between items-center mb-8">
              ...
              <Link to="/notifications" className="text-[11px] font-bold uppercase text-primary-500 tracking-wider hover:text-primary-600 transition-colors">View All Updates</Link>
            </div>
            <div className="space-y-4">
              {notifications.map((notif, index) => (
                <div 
                  ...
                  className="bg-sand-50 dark:bg-zinc-900/50 p-4 sm:p-5 rounded-2xl border border-zinc-200/50 dark:border-zinc-850/40 flex gap-3 sm:gap-4 hover:shadow-md hover:border-primary-500/20 transition-all cursor-pointer group"
                >
                  <div className="w-10 h-10 sm:w-11 sm:h-11 shrink-0 rounded-xl bg-primary-500/10 text-primary-500 flex items-center justify-center group-hover:bg-primary-600 group-hover:text-white transition-all"><Bell size={18} /></div>
                  <div className="flex-grow min-w-0 text-left">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="text-[10px] font-semibold text-primary-500 uppercase tracking-wider">{notif.timestamp}</span>
                    </div>
                    <h4 className="font-bold text-base text-zinc-900 dark:text-zinc-100 mb-1 truncate group-hover:text-primary-500 transition-colors font-display">{notif.title}</h4>
                    <p className="text-xs text-zinc-500 dark:text-zinc-400 line-clamp-1 font-medium">{notif.description}</p>
                  </div>
                  <div className="w-8 h-10 sm:h-11 shrink-0 flex items-center justify-center text-zinc-300 dark:text-zinc-700 group-hover:text-primary-500 transition-all">
          ...
          <section className="text-left">
            ...
            <div className="bg-sand-50 dark:bg-zinc-900/50 p-6 sm:p-8 rounded-2xl border border-zinc-200/50 dark:border-zinc-850/40 relative overflow-hidden flex flex-col justify-center min-h-[220px] text-left shadow-sm group">
              <Quote className="text-primary-500 opacity-5 absolute top-6 right-6" size={70} />
              <div className="relative z-10 space-y-4">
                <span className="text-[10px] font-semibold uppercase tracking-widest text-primary-500 block">Campus Quote</span>
        ...
        {/* AdSense Rich Article Content Section: Eliminating "Low Value Content" */}
        <section className="mt-12 bg-white dark:bg-zinc-900/60 rounded-[2.5rem] p-8 md:p-12 border border-zinc-200/80 dark:border-zinc-800 space-y-8 text-left shadow-xs">
          <div className="space-y-3 border-b border-zinc-100 dark:border-zinc-800 pb-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#fe7f2d]/10 text-[#fe7f2d] rounded-full text-[10px] font-black uppercase tracking-widest">
              <GraduationCap size={14} /> Comprehensive Student Guide
            </div>
            <h2 className="text-2xl md:text-4xl font-black text-zinc-900 dark:text-white tracking-tight">
              Navigating Lovely Professional University: The Ultimate Student OS Handbook
            </h2>
            <p className="text-zinc-500 dark:text-zinc-400 text-sm font-medium leading-relaxed max-w-3xl">
              Written by senior peer mentors and LPU alumni, this comprehensive overview breaks down everything you need to know about academic policies, housing, campus fests, and student marketplace trading at LPU.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-zinc-700 dark:text-zinc-300 text-sm leading-relaxed">
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-zinc-950 dark:text-white flex items-center gap-2">
                <Award size={18} className="text-[#fe7f2d]" /> 1. Academic Survival & CGPA Strategy
              </h3>
              <p>
                Academic performance at Lovely Professional University relies on a balanced evaluation system comprising Mid-Term Examinations, End-Term Examinations, Continuous Assessment (CA), and Practical Vivas. 
              </p>
              <ul className="list-disc pl-5 space-y-1.5 text-xs text-zinc-500 dark:text-zinc-400">
                <li><strong>75% Mandatory Attendance:</strong> Falling below 75% triggers an automatic block on UMS, leading to 'E' or 'F' grade shortfalls. Monitor your LPU Touch daily.</li>
                <li><strong>Continuous Assessment (CA):</strong> CA accounts for up to 30% of your total grade. Submitting quizzes, PPTs, and coding assignments on time is the single easiest way to maintain an 8.5+ CGPA.</li>
                <li><strong>Duty Leaves (DL):</strong> Official duty leaves can safeguard your attendance when representing LPU in YouthVibe, Sports, or placement drives. Submit DL applications within 7 days on UMS.</li>
              </ul>
            </div>

            <div className="space-y-4">
              <h3 className="text-lg font-bold text-zinc-950 dark:text-white flex items-center gap-2">
                <Bed size={18} className="text-[#fe7f2d]" /> 2. Student Housing: On-Campus vs. Law Gate
              </h3>
              <p>
                Choosing where to live significantly shapes your college experience. On-campus BH/GH hostels provide maximum security and zero commute, while off-campus PGs around Law Gate offer greater freedom and independent dining.
              </p>
              <ul className="list-disc pl-5 space-y-1.5 text-xs text-zinc-500 dark:text-zinc-400">
                <li><strong>Law Gate Hub:</strong> Packed with food dhabas, gyms, stationery shops, and private PG rooms. Ideal for students seeking independent living.</li>
                <li><strong>GT Road & Deep Nagar:</strong> Offers quieter apartments and cheaper 2BHK/3BHK flat rentals for senior groups sharing accommodation.</li>
                <li><strong>Rental Checklist:</strong> Always verify commercial vs. residential electricity billing rates (typically ₹10-₹12/unit) and inspect water pressure before paying security deposits.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800 space-y-4">
            <h3 className="text-lg font-bold text-zinc-950 dark:text-white flex items-center gap-2">
              <HelpCircle size={18} className="text-[#fe7f2d]" /> Frequently Asked Questions by LPU Students
            </h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl border border-zinc-200/50 dark:border-zinc-800 space-y-1">
                <h4 className="font-bold text-zinc-900 dark:text-zinc-100">Is ALFA officially affiliated with LPU?</h4>
                <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  No. ALFA Portal is a completely independent, non-profit peer network created by and for students. For official university administration, visit lpu.in or your UMS dashboard.
                </p>
              </div>

              <div className="p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl border border-zinc-200/50 dark:border-zinc-800 space-y-1">
                <h4 className="font-bold text-zinc-900 dark:text-zinc-100">Are academic notes on ALFA free to download?</h4>
                <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  Yes, 100% free! All subject notes, previous year question papers (PYQs), and assignment guides are contributed by high-scoring senior peers to assist the student community.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* AdSense Ad Unit Placement 2 */}
        <div className="my-6">
          <AdUnit label="Sponsored LPU Career & Educational Links" slot="2938475601" />
        </div>
          ...
          <div className="bg-gradient-to-br from-accent-900 to-accent-950 dark:from-zinc-900 dark:to-zinc-950 rounded-[2rem] p-6 sm:p-8 md:p-12 text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl border border-zinc-200/20 dark:border-zinc-850/40 relative overflow-hidden group">
            <div className="space-y-5 relative z-10 text-center md:text-left max-w-xl">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 sm:px-8 py-3.5 sm:py-4 bg-sand-50 text-accent-900 hover:bg-sand-200 rounded-xl font-bold text-xs uppercase tracking-widest shadow-xl transition-all font-display"
              >
          ...
          <div className="bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 dark:from-emerald-950/90 dark:via-zinc-900 dark:to-teal-950 rounded-[2.5rem] p-6 sm:p-8 md:p-12 text-white shadow-2xl relative overflow-hidden group border border-emerald-500/30">
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="space-y-4 max-w-2xl text-left">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-xs font-black uppercase tracking-widest text-emerald-200">
                ...
                <p className="text-emerald-100 text-sm md:text-base font-medium leading-relaxed">
                  Connect with 10,000+ fellow LPU students! Receive instant updates for exam dates, syllabus notes, duty leaves, campus fests, marketplace deals, and room openings.
                </p>
              </div>

              <div className="shrink-0 w-full lg:w-auto flex flex-col items-center gap-4 bg-white/10 backdrop-blur-xl p-6 sm:p-8 rounded-3xl border border-white/20 text-center shadow-xl">
                <div className="w-20 h-20 bg-[#25D366] text-white rounded-3xl flex items-center justify-center shadow-lg shadow-[#25D366]/40">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto px-8 py-4 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl flex items-center justify-center gap-2 font-display"
                >
            ...
            <div className="space-y-4 flex flex-col">
              ...
              <div className="bg-sand-50 dark:bg-zinc-900/50 rounded-[2rem] border border-zinc-200/50 dark:border-zinc-850/40 p-6 sm:p-8 md:p-10 shadow-sm flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group flex-1">
                <div className="w-32 h-32 rounded-2xl bg-indigo-50 dark:bg-indigo-900/20 overflow-hidden shrink-0 border border-zinc-200 dark:border-zinc-800 shadow-md relative group/dev">
                  <img src="https://i.postimg.cc/d0dg476z/Chat-GPT-Image-Jun-11-2025-07-35-42-AM.png" alt="Harsha Bacham" className="w-full h-full object-cover" />
                </div>
                <div className="flex-grow space-y-4 text-center md:text-left">
                  <div>
                    ...
                    <p className="text-primary-500 font-bold text-[10px] uppercase tracking-widest mt-1 font-display">Lead Creator & Founder</p>
                  </div>
                  <p className="text-zinc-500 dark:text-zinc-400 text-xs md:text-sm leading-relaxed max-w-xl font-medium">
                    Focused on creating open-access academic and community tools for Lovely Professional University students.
                  </p>
                  <div className="flex justify-center md:justify-start gap-3">
                    <a href="https://www.linkedin.com/in/harsha-bacham/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center bg-[#0077b5] text-white rounded-lg shadow-sm"><Linkedin size={15} /></a>
                    <a href="https://www.instagram.com/harsha_bacham/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center bg-[#e1306c] text-white rounded-lg shadow-sm"><Instagram size={15} /></a>
                    <a href="https://github.com/harshabacham" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center bg-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 text-white rounded-lg shadow-sm"><Github size={15} /></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 flex flex-col">
              ...
              <div className="bg-sand-50 dark:bg-zinc-900/50 rounded-[2rem] border border-zinc-200/50 dark:border-zinc-850/40 p-6 sm:p-8 md:p-10 shadow-sm flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group flex-1">
                ...
                <div className="flex-grow space-y-4 text-center md:text-left">
                  ...
                  <p className="text-zinc-500 dark:text-zinc-400 text-xs md:text-sm leading-relaxed max-w-xl font-medium">
                    ALFA is completely free to use. Support our server hosting and domain costs!
                  </p>
      ...
      {showScrollTop && !selectedNotif && (
        <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="fixed bottom-24 right-8 z-[90] w-10 h-10 bg-primary-600 text-white rounded-xl shadow-lg flex items-center justify-center hover:scale-110 transition-all cursor-pointer"><ArrowUp size={18} /></button>
      )}
          ...
          >
            <div className="p-6 pb-3 flex justify-between items-start border-b border-zinc-100 dark:border-zinc-800/60">
              ...
              <button 
                ...
                className="p-2 bg-zinc-100 dark:bg-zinc-800 text-zinc-400 rounded-lg hover:bg-red-500 hover:text-white transition-all cursor-pointer"
              >
                <X size={16} />
              </button>
            </div>
            ...
            <div className="p-6 pt-3 bg-zinc-50 dark:bg-zinc-900/60 border-t border-zinc-100 dark:border-zinc-800/60 flex gap-3">
              <button 
                ...
                className="flex-1 py-3.5 bg-sand-50 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700 rounded-xl font-bold text-xs uppercase tracking-wider font-display"
              >
                <Share2 size={14} /> Share Update
              </button>
              <button 
                onClick={() => setSelectedNotif(null)} 
                className="flex-1 py-3.5 bg-primary-600 text-white rounded-xl font-bold text-xs uppercase tracking-wider font-display"
              >
                Got It
              </button>
            </div>
